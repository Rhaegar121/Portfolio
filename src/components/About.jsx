    ...
    <div>
      ...
      <div className={style.content}>
        <motion.div variants={slideIn("left", "", 0, 1)} className={style.para}>
          <p className={style.text}>My name is <a href='https://www.linkedin.com/in/kaungmyatkyaw/' target='_blank' className={style.link}>Kaung Myat Kyaw (Barry)</a> and I am a passionate software engineer for delivering state-of-the-art software solutions in React and Ruby on Rails. I've spent the last several months developing real-world projects from scratch in a remote environment. I love Math, Coding, Movies, and all kinds of Music.</p>
