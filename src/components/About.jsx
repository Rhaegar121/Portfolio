    ...
    <div>
      ...
      <div className={style.content}>
        <motion.div variants={slideIn("left", "", 0, 1)} className={style.para}>
          <p className={style.text}>My name is <a href='https://www.linkedin.com/in/kaungmyatkyaw/' target='_blank' className={style.link}>Kaung Myat Kyaw (Barry)</a>, and I've spent the last several months developing real-world projects from scratch in a remote environment. I love math, programming, movies, and all kinds of music and according to GitHub, I am now <a href='https://commits.top/myanmar_public.html' target='_blank' className={style.link}>Top 7</a> contributor in my country.</p>
